...
export default defineType({
  ...
  fields: [
    { name: 'text', type: 'string', label: 'Text', required: true, listColumn: true, help: 'e.g. "Dwarka, Delhi".' },
    { name: 'emphasis', type: 'string', label: 'Bold part', listColumn: true, help: 'Rendered bold before the text, e.g. "Manipal Hospital".' },
