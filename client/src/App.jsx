...
const WA_NUMBER_FALLBACK = '919811094112'
const WA_MSG_FALLBACK = "Hi Dr. Naman, I'd like to book a consultation."
...
function WhatsAppFloat() {
  ...
  const number = contact.whatsappNumber || WA_NUMBER_FALLBACK
  const message = contact.whatsappMessage || WA_MSG_FALLBACK
...
export function Shell({ initialContent } = {}) {
  useScrollProgress()
  useCursor()
  return (
    <ContentProvider initialState={initialContent}>
      <KidneySymbol/>
      <Preloader/>
      <Cursor/>
      <VitalBar/>
